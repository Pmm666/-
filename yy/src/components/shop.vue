<template>
  <div id="div2">
    ...
    >
      ...
      <el-table-column property="name" label="店铺名称" width="220"></el-table-column>
      <el-table-column property="address" label="店铺地址" width="220"></el-table-column>
      <el-table-column property="longitude" label="店铺介绍"> </el-table-column>
      <el-table-column property="" label="操作">
      <span><button class="bian">编辑</button></span>
        <span><button class="tian">添加食品</button></span>
...
<script>
  ...
  export default {
    ...
    created() {
      axios.get("https://elm.cangdu.org/shopping/restaurants?latitude=39.90469&longitude=116.407173&offset=0&limit=20").then(
        item => {
