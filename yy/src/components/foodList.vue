<template>
  <div id="div2">
    ...
    >
      ...
      <el-table-column property="name" label="食品名称" width="220"></el-table-column>
      <el-table-column property="description" label="食品介绍" width="220"></el-table-column>
      <el-table-column property="rating" label="评分"> </el-table-column>
...
<script>
  ...
  export default {
    ...
    created() {
      axios.get("https://elm.cangdu.org/shopping/v2/foods?offset=0&limit=20&restaurant_id=undefined").then(
        item => {
