        ...
        <el-menu
          ...
          <el-submenu index="1">
            ...
            <el-menu-item-group>
              ...
              <el-menu-item index="1-3"><router-link to="/foodList">食品列表</router-link></el-menu-item>
            <el-submenu index="1-4">
              <template slot="title"><router-link to="/orderList">订单列表</router-link></template>
            </el-submenu>
            <el-submenu index="1-5">
              <template slot="title"><router-link to="/adminList">管理员列表</router-link></template>
            </el-submenu>
          </el-submenu>
          <el-submenu index="2">
            <template slot="title">
